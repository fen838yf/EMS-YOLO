...
The EMS-YOLO model code is associated with a paper published in the Visual Computer journal. You may optimize the model based on this work, but proper attribution to the source is required. 
